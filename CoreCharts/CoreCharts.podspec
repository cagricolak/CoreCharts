#
#  Be sure to run `pod spec lint CoreCharts.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "CoreCharts is a simple powerfullyet Charts library for apple products in the world"

   s.homepage     = "https://cagricolak.github.io/CoreCharts/"
  ...
  s.source_files  = "CoreCharts", "CoreCharts/**/*.{h,m,swift}"

  # s.exclude_files = "Classes/Exclude"

  #s.public_header_files = "CoreCharts/**/*.h"
